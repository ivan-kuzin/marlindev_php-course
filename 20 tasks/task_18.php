                            ...
                            <div class="panel-content">
                                <div class="panel-content">
                                    <div class="form-group">
                                        ...
                                        ?>
                                        <?php
                                        $url = ((!empty($_SERVER['HTTPS'])) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'] . '/task_18_handler.php';
                                        ?>
                                        ...
                                        <?php
                                            ...
                                            if ( !empty($images) ){
                                                foreach ( $images as $image ){
                                                    ...
                                                    echo '<img src="/task_18_upload/'. $image['filename'] .'" >';
                                                    echo '<a class="btn btn-danger" href="/task_18_delete.php?image_id='. $image['id'] .'" onclick="confirm(\'Вы уверены?\');">Удалить</a>';
                                                    echo '</div>';
                                                }
                                            }else{
